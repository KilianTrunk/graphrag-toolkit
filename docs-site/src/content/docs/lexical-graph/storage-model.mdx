...
The toolkit provides graph store implementations for both [Amazon Neptune Analytics](https://docs.aws.amazon.com/neptune-analytics/latest/userguide/what-is-neptune-analytics.html) and [Amazon Neptune Database](https://docs.aws.amazon.com/neptune/latest/userguide/intro.html) (engine version 1.4.1.0 or later), [Neo4j](/graphrag-toolkit/lexical-graph/graph-store-neo4j/), and contributor packages for [FalkorDB](/graphrag-toolkit/lexical-graph/graph-store-falkor-db/) and [RDFox](/graphrag-toolkit/lexical-graph/graph-store-rdfox/), along with vector store implementations for Neptune Analytics, [Amazon OpenSearch Serverless](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/serverless.html), Postgres with the pgvector extension, and Amazon S3 Vectors. The lexical-graph provides several convenient factory methods for creating instances of these stores.
...
The lexical-graph supports the following graph databases:
  ...
  - [RDFox](/graphrag-toolkit/lexical-graph/graph-store-rdfox/)
